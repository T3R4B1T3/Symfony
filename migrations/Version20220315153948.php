 ...
 */
final class Version20220315153948 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog_article ADD categorry_id INT NOT NULL');
        $this->addSql('ALTER TABLE blog_article ADD CONSTRAINT FK_EECCB3E5B10AA999 FOREIGN KEY (categorry_id) REFERENCES blog_category (id)');
