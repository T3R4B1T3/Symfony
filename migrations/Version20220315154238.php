 ...
 */
final class Version20220315154238 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog_article DROP FOREIGN KEY FK_EECCB3E5B10AA999');
        $this->addSql('DROP INDEX IDX_EECCB3E5B10AA999 ON blog_article');
        $this->addSql('ALTER TABLE blog_article CHANGE categorry_id category_id INT NOT NULL');
